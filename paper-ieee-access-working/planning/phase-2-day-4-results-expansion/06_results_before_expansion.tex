...
\noindent\textit{Artifact availability:} The repository includes the raw outputs, derived summaries, confusion-matrix data, and publication-ready figures required to reproduce the reported results; Table~\ref{tab:artifact-availability} lists the corresponding paths.
\begin{figure}[t]
\centering
